...
const TournamentFrame = ({ tournament }: Props) => {
  return (
    <Link
      className="w-5/12 transition hover:text-gray-700 md:w-[300px]"
      to={`/tournament/${tournament.id}`}
    >
      <div className="w-full cursor-pointer rounded-2xl bg-white bg-opacity-60 p-10 shadow-sm transition hover:bg-black hover:bg-opacity-20 md:w-[300px]">
        <div>
          <img
